 ...
 */
final class Version20240914142858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, blogueur_articles_id INT DEFAULT NULL, entete VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, accroche LONGTEXT NOT NULL, texte LONGTEXT NOT NULL, INDEX IDX_BFDD316867B3B43D (users_id), INDEX IDX_BFDD316878A9D3E7 (blogueur_articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenements (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, admin_evenements_id INT DEFAULT NULL, date DATE NOT NULL, donations INT NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_E10AD40067B3B43D (users_id), INDEX IDX_E10AD400BD02F3B3 (admin_evenements_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE outsiders (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, admin_outsiders_id INT DEFAULT NULL, pseudo VARCHAR(50) NOT NULL, twitch VARCHAR(255) NOT NULL, somme INT NOT NULL, INDEX IDX_AE8D092967B3B43D (users_id), INDEX IDX_AE8D09296A575EC8 (admin_outsiders_id), UNIQUE INDEX UNIQ_PSEUDO (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE presentations (id INT AUTO_INCREMENT NOT NULL, streamers_presentation_id INT DEFAULT NULL, picture VARCHAR(255) NOT NULL, question1 LONGTEXT NOT NULL, question2 LONGTEXT NOT NULL, question3 LONGTEXT NOT NULL, clip1 VARCHAR(255) DEFAULT NULL, clip2 VARCHAR(255) DEFAULT NULL, clip3 VARCHAR(255) DEFAULT NULL, clip4 VARCHAR(255) DEFAULT NULL, planning VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_72936B1D52F21B7C (streamers_presentation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE socials_network (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_FE38835AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, streamers_presentation_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(50) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, is_valid TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1483A5E952F21B7C (streamers_presentation_id), UNIQUE INDEX UNIQ_PSEUDO (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
